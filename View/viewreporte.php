                                                        ...
                                                        <div class="card-block text-center">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <p class="text-muted">Generar reporte de: </p>
                                                                    <h4>DOCENTES</h4>
                                                                    <a href="ReporteDocente.php" class="btn btn-primary" >Generar Reporte</a>
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <p class="text-muted">Generar reporte de: </p>
                                                                    <h4>ESTUDIANTES</h4>
                                                                    <a href="ReporteEstudiantes.php" class="btn btn-primary">Generar Reporte</a>
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <a href="ReporteAdministrativos.php" class="btn btn-primary">Generar Reporte</a>
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <a href="ReporteGeneral.php" class="btn btn-primary">Generar Reporte</a>
