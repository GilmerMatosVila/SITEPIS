        ...
        if (isset($_GET["reporte"])) {
            ...
            if ($_GET["reporte"] == "atencion") {
                ...
                echo utf8_decode("
					...
					<table border='0'>
						...
						<tr>
							...
							<td style='font-weight:bold; border:1px solid #eee;'>ID DOCENTE</td>
							<td style='font-weight:bold; border:1px solid #eee;'>FECHA DE ANTENCIÓN</td>
                ...
                if ($value["user_level"] == "3") {
                    ...
                    echo utf8_decode("
					 	...
					 	<tr>
							<td style='border:1px solid #eee;'>" . $value["id_atencion"] . "</td>
							<td style='border:1px solid #eee;'>" . $value["hora_add"] . "</td>

					 ");

                    echo utf8_decode("<td style='border:1px solid #eee;'>" . $value["id_docente"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["fecha_atencion"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["diagnotico"] . "</td>
			 					  	  <td style='border:1px solid #eee;'>" . $value["tratamiento"] . "</td>
            ...
            if ($_GET["reporte"] == "atencion") {
                ...
                echo utf8_decode("
					...
					<table border='0'>
						...
						<tr>
                            <h2>Atención Administrativo</h2>
							<td style='font-weight:bold; border:1px solid #eee;'>ID</td>
							<td style='font-weight:bold; border:1px solid #eee;'>HORA</td>
							<td style='font-weight:bold; border:1px solid #eee;'>ID ADMINISTRATIVO</td>
							<td style='font-weight:bold; border:1px solid #eee;'>DIAGNOSTICO</td>
                            <td style='font-weight:bold; border:1px solid #eee;'>TRATAMIENTO</td>
                ...
                if ($value["user_level"] == "2") {
                    ...
                    echo utf8_decode("<td style='border:1px solid #eee;'>" . $value["id_administrativo"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["fecha_atencion"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["diagnotico"] . "</td>
			 					  	  <td style='border:1px solid #eee;'>" . $value["tratamiento"] . "</td>
            ...
            if ($_GET["reporte"] == "atencion") {
                ...
                echo utf8_decode("
					...
					<table border='0'>
						...
						<tr>
							...
							<td style='font-weight:bold; border:1px solid #eee;'>ID</td>
							<td style='font-weight:bold; border:1px solid #eee;'>HORA</td>
							<td style='font-weight:bold; border:1px solid #eee;'>ID ESTUDIANTE</td>
                            <td style='font-weight:bold; border:1px solid #eee;'>FECHA DE ATENCIÓN</td>
							<td style='font-weight:bold; border:1px solid #eee;'>DIAGNOSTICO</td>
                            <td style='font-weight:bold; border:1px solid #eee;'>TRATAMIENTO</td>
                            <td style='font-weight:bold; border:1px solid #eee;'>ID MEDICAMENTO</td>
                            <td style='font-weight:bold; border:1px solid #eee;'>CANTIDAD DE MEDICAMENTO</td>
                ...
                if ($value["user_level"] == "1") {
                    ...
                    echo utf8_decode("<td style='border:1px solid #eee;'>" . $value["id_estudiante"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["fecha_atencion"] . "</td>
			 					  	 <td style='border:1px solid #eee;'>" . $value["diagnotico"] . "</td>
			 					  	  <td style='border:1px solid #eee;'>" . $value["tratamiento"] . "</td>
                                         <td style='border:1px solid #eee;'>" . $value["idMedicamento"] . "</td>
                                         <td style='border:1px solid #eee;'>" . $value["cantMedicamento"] . "</td>
